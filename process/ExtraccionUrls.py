...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
Lee la carpeta G3DL en Google Drive, construye las URLs
...
SPREADSHEET_ID    = "1Mn_osjpufPp3jBsIl_5sK7FSPagUPDuQtpoCHPxQQkM"  # ← ID de tu Google Sheet
G3DL_FOLDER_ID = "12MPJBNSBO9GasktGrrP8q8ridX38bC9i"    # ← ID de la carpeta G3DL en Drive
...
def main():
    ...
    # 2. Leer carpetas de G3DL en Drive
    print(f"📁 Leyendo carpetas en Drive (ID: {G3DL_FOLDER_ID})...")
    carpetas = listar_todas_las_carpetas(drive_service, G3DL_FOLDER_ID)
    print(f"   ✅ {len(carpetas)} carpetas encontradas\n")

    if not carpetas:
        print("❌ No se encontraron subcarpetas. Verificá el G3DL_FOLDER_ID.")
        input("\nPresioná Enter para cerrar...")
        sys.exit(1)
